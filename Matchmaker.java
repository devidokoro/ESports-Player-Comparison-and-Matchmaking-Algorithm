...
public class Matchmaker {
	...
	public ArrayList<ESportsPlayer> generateTeam() {
		...
		for (int i = 0; i < TEAM_SIZE; i++) {
			...
			int kills = gen.nextInt(10000); //random kills
			int games = 1 + gen.nextInt(10000); //random games
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter total games you have played: ");
